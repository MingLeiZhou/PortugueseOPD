...
OSM/Geofabrik 150/220/400 kV network
...
\bottomrule\noalign{}
\endlastfoot
E-REDES / RND AT & Continental 60/130 kV; archived snapshot & Lines,
facilities, codes, and geometry & Network construction \\
...
energy is converted to interval-average power as
...
timestamps denote interval ends:
...
nodal load. The unobserved national residual is

\[
R_t=P^{\mathrm{REN}}_{\mathrm{consumption},t}-\sum_j P^{\mathrm{EREDES}}_{j,t}.
\]

The residual is assigned to mapped delivery points using the PDIRT
public reference profile from the same season and closest national-load
condition (\hyperref[ref-ERSEPDIRT2024]{REN, 2024}):
...
convergence, voltage, loading, and active-power balance,
...
\pandocbounded{\includegraphics[keepaspectratio]{figures_final/fig11_grid_stress.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{figures_final/fig12_annual_nminus1.pdf}}
