...
SimPT60 的核心贡献是首次在同一可追溯、版本化的数据产品中连接葡萄牙大陆 60–400 kV 公开网络重建与 31,492 个连续的 15 分钟交流潮流状态。数据集覆盖葡萄牙大陆及西班牙互联边界端点，归档网络包含 3,783 个母线、4,943 条线路和 228 个变压器对象；来源记录、分配规则、工程代理和求解状态共同支持断面复算与方法比较。
