...
\begin{figure}[t]
  ...
  \caption{Fail-closed reconstruction and release workflow for \dataset. The gray box denotes public inputs; blue boxes denote transformations or validation; the yellow diamond is the declared retention gate; green boxes denote retained and packaged release records; the orange box preserves downgraded/rejected records; and the purple box records provenance and reuse contracts. Counts are read from the frozen v1.0.2 release. They describe dataset construction and internal checks, not physical-topology accuracy.}
  \label{fig:pipeline}
\end{figure}
