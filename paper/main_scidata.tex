...
\begin{figure}[t]
  ...
  \caption{Fail-closed reconstruction and release workflow for \dataset. Rectangles distinguish public inputs, processing stages, validation, provenance contracts, and released records; the diamond is the declared inter-facility retention gate. The pass and fail-closed paths preserve retained and non-retained outcomes separately before common validation and packaging. Counts are read from the frozen v1.0.2 release and describe dataset construction and internal checks, not physical-topology accuracy.}
  \label{fig:pipeline}
\end{figure}
