...
FIGURES = [
    {
        ...
        "sources": [
            "data/releases/PT60-Candidate-v1.0.2/core_topology/at_paper_logic_summary.json",
            "data/releases/PT60-Candidate-v1.0.2/validation/internal_validation_summary.json",
            "data/releases/PT60-Candidate-v1.0.2/validation/pt_topology_cross_validation_summary.json",
        ],
        "generator": "paper/scripts/generate_quantitative_figures.py",
        "stem": "fig1_pipeline_overview",
        "width": "double-column",
        "caption": "Fail-closed reconstruction and release workflow. The 216-setting sweep and documented selection rule precede the selected configuration and retention gate. Pass and fail-closed branches preserve retained and non-retained outcomes separately. OSM-derived public evidence enters only the validation stage and does not affect reconstruction.",
        "uncertainty": "Counts are deterministic for the frozen release; the diagram does not estimate physical-topology accuracy.",
        "provenance_notes": "Generated as vector artwork by Matplotlib from frozen topology, internal-validation, and public-source-validation JSON; no manual editing of outputs.",
    ...
    },
    {
        ...
        "claim": "The selected strategy converts 5,334 raw line features into 1,341 circuits and retains 358 inter-facility candidates while preserving rejected classes.",
        "sources": ["data/releases/PT60-Candidate-v1.0.2/core_topology/at_paper_logic_summary.json"],
        "generator": "paper/scripts/generate_quantitative_figures.py",
    ...
    },
    {
        ...
        "sources": ["data/releases/PT60-Candidate-v1.0.2/core_topology/at_paper_logic_graph.graphml", "data/releases/PT60-Candidate-v1.0.2/core_topology/at_interfacility_candidate_branches.csv"],
        "generator": "paper/scripts/generate_quantitative_figures.py",
    ...
    },
    {
        ...
        "sources": ["data/releases/PT60-Candidate-v1.0.2/core_topology/at_paper_logic_parameter_sweep.csv"],
        "generator": "paper/scripts/generate_quantitative_figures.py",
