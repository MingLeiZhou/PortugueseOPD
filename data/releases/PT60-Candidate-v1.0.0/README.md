...
Code DOI remains pending; local code tag is `pt60-candidate-v1.0.0-rc1`. See `manifest.json`, `checksums.sha256`, `schema/`, `inventory/headline_counts.json` and `excluded_artifacts.json` for archive contents, schemas, checksums and exclusions.
